...
def test_llm_agent(provider, prompt, output_file=None):
    ...
    try:
        ...
        for i, suggestion in enumerate(suggestions):
            ...
            print(f"  - Properties to change: {len(changes.get('operatorPropertiesToChange', []))}")
...
if __name__ == "__main__":
    ...
    agent_parser.add_argument("--provider", choices=["openai", "anthropic"], 
                             default=os.environ.get("LLM_PROVIDER", "openai"),
                             help="LLM provider to use")
    agent_parser.add_argument("--prompt", type=str, required=True,
                             help="Prompt to send to the LLM")
    agent_parser.add_argument("--output", type=str, 
    ...
    formatter_parser.add_argument("--input", type=str, required=True,
                                 help="Raw JSON file to format")
    formatter_parser.add_argument("--output", type=str,
                                 help="File to save the formatted output to")
