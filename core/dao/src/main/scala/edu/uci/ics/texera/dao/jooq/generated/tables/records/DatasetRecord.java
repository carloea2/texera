...
public class DatasetRecord extends UpdatableRecordImpl<DatasetRecord> implements Record7<Integer, Integer, String, Boolean, Boolean, String, Timestamp>, IDataset {
    ...
    @Override
    public DatasetRecord values(Integer value1, Integer value2, String value3, Boolean value4, Boolean value5, String value6, Timestamp value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public DatasetRecord(Integer did, Integer ownerUid, String name, Boolean isPublic, Boolean isDownloadable, String description, Timestamp creationTime) {
        super(Dataset.DATASET);
