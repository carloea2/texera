...
public class ModelViewCount extends TableImpl<ModelViewCountRecord> {
     ...
     */
    public final TableField<ModelViewCountRecord, Integer> MID = createField(DSL.name("mid"), SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>texera_db.model_view_count.view_count</code>.
     */
    public final TableField<ModelViewCountRecord, Integer> VIEW_COUNT = createField(DSL.name("view_count"), SQLDataType.INTEGER.nullable(false).defaultValue(DSL.field("0", SQLDataType.INTEGER)), this, "");

    private ModelViewCount(Name alias, Table<ModelViewCountRecord> aliased) {
        this(alias, aliased, null);
    }

    private ModelViewCount(Name alias, Table<ModelViewCountRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment(""), TableOptions.table());
    }

    /**
     * Create an aliased <code>texera_db.model_view_count</code> table reference
     */
    ...
    public <O extends Record> ModelViewCount(Table<O> child, ForeignKey<O, ModelViewCountRecord> key) {
    ...
    public Model model() {
        if (_model == null)
            _model = new Model(this, Keys.MODEL_VIEW_COUNT__MODEL_VIEW_COUNT_MID_FKEY);
