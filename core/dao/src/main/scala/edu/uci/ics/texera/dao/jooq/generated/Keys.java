...
public class Keys {
    ...
    public static final UniqueKey<ModelRecord> MODEL_PKEY = Internal.createUniqueKey(Model.MODEL, DSL.name("model_pkey"), new TableField[] { Model.MODEL.MID }, true);
    public static final UniqueKey<ModelUserAccessRecord> MODEL_USER_ACCESS_PKEY = Internal.createUniqueKey(ModelUserAccess.MODEL_USER_ACCESS, DSL.name("model_user_access_pkey"), new TableField[] { ModelUserAccess.MODEL_USER_ACCESS.MID, ModelUserAccess.MODEL_USER_ACCESS.UID }, true);
    public static final UniqueKey<ModelUserLikesRecord> MODEL_USER_LIKES_PKEY = Internal.createUniqueKey(ModelUserLikes.MODEL_USER_LIKES, DSL.name("model_user_likes_pkey"), new TableField[] { ModelUserLikes.MODEL_USER_LIKES.UID, ModelUserLikes.MODEL_USER_LIKES.MID }, true);
    public static final UniqueKey<ModelVersionRecord> MODEL_VERSION_PKEY = Internal.createUniqueKey(ModelVersion.MODEL_VERSION, DSL.name("model_version_pkey"), new TableField[] { ModelVersion.MODEL_VERSION.MVID }, true);
    public static final UniqueKey<ModelViewCountRecord> MODEL_VIEW_COUNT_PKEY = Internal.createUniqueKey(ModelViewCount.MODEL_VIEW_COUNT, DSL.name("model_view_count_pkey"), new TableField[] { ModelViewCount.MODEL_VIEW_COUNT.MID }, true);
    ...
    public static final ForeignKey<ModelRecord, UserRecord> MODEL__MODEL_OWNER_UID_FKEY = Internal.createForeignKey(Model.MODEL, DSL.name("model_owner_uid_fkey"), new TableField[] { Model.MODEL.OWNER_UID }, Keys.USER_PKEY, new TableField[] { User.USER.UID }, true);
    public static final ForeignKey<ModelUserAccessRecord, ModelRecord> MODEL_USER_ACCESS__MODEL_USER_ACCESS_MID_FKEY = Internal.createForeignKey(ModelUserAccess.MODEL_USER_ACCESS, DSL.name("model_user_access_mid_fkey"), new TableField[] { ModelUserAccess.MODEL_USER_ACCESS.MID }, Keys.MODEL_PKEY, new TableField[] { Model.MODEL.MID }, true);
    public static final ForeignKey<ModelUserAccessRecord, UserRecord> MODEL_USER_ACCESS__MODEL_USER_ACCESS_UID_FKEY = Internal.createForeignKey(ModelUserAccess.MODEL_USER_ACCESS, DSL.name("model_user_access_uid_fkey"), new TableField[] { ModelUserAccess.MODEL_USER_ACCESS.UID }, Keys.USER_PKEY, new TableField[] { User.USER.UID }, true);
    public static final ForeignKey<ModelUserLikesRecord, ModelRecord> MODEL_USER_LIKES__MODEL_USER_LIKES_MID_FKEY = Internal.createForeignKey(ModelUserLikes.MODEL_USER_LIKES, DSL.name("model_user_likes_mid_fkey"), new TableField[] { ModelUserLikes.MODEL_USER_LIKES.MID }, Keys.MODEL_PKEY, new TableField[] { Model.MODEL.MID }, true);
    public static final ForeignKey<ModelUserLikesRecord, UserRecord> MODEL_USER_LIKES__MODEL_USER_LIKES_UID_FKEY = Internal.createForeignKey(ModelUserLikes.MODEL_USER_LIKES, DSL.name("model_user_likes_uid_fkey"), new TableField[] { ModelUserLikes.MODEL_USER_LIKES.UID }, Keys.USER_PKEY, new TableField[] { User.USER.UID }, true);
    public static final ForeignKey<ModelVersionRecord, ModelRecord> MODEL_VERSION__MODEL_VERSION_MID_FKEY = Internal.createForeignKey(ModelVersion.MODEL_VERSION, DSL.name("model_version_mid_fkey"), new TableField[] { ModelVersion.MODEL_VERSION.MID }, Keys.MODEL_PKEY, new TableField[] { Model.MODEL.MID }, true);
    public static final ForeignKey<ModelViewCountRecord, ModelRecord> MODEL_VIEW_COUNT__MODEL_VIEW_COUNT_MID_FKEY = Internal.createForeignKey(ModelViewCount.MODEL_VIEW_COUNT, DSL.name("model_view_count_mid_fkey"), new TableField[] { ModelViewCount.MODEL_VIEW_COUNT.MID }, Keys.MODEL_PKEY, new TableField[] { Model.MODEL.MID }, true);
