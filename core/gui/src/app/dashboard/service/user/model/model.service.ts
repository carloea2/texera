...
import { Dataset, DatasetVersion, Model } from "../../../../common/type/dataset";
...
export class ModelService {
  ...
  public createModel(model: Model): Observable<DashboardDataset> {
    return this.http.post<DashboardDataset>(`${AppSettings.getApiEndpoint()}/${MODEL_CREATE_URL}`, {
  ...
  public getDatasetDiff(did: number): Observable<DatasetStagedObject[]> {
    return this.http.get<DatasetStagedObject[]>(`${AppSettings.getApiEndpoint()}/${MODEL_BASE_URL}/${did}/diff`);
  }
